...
namespace Entidades
{
    ...
    public sealed class Taller
    {
        ...
        {
            if (!taller.vehiculos.Exists(k => k == vehiculo) && taller.vehiculos.Count < taller.espacioDisponible && taller.espacioDisponible > 1)
            {
        ...
        public static Taller operator -(Taller taller, Vehiculo vehiculo)
        {
            if (taller.vehiculos.Exists(k => k == vehiculo))
            {
